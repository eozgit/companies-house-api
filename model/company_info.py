...
class CompanyInfo(db.Model):
    ...
    dissolution_date = db.Column(db.String(0))
    incorporation_date = db.Column(db.String(10))
    accounts_account_ref_day = db.Column(db.String(2))
    accounts_account_ref_month = db.Column(db.String(2))
    accounts_next_due_date = db.Column(db.String(10))
    accounts_last_made_up_date = db.Column(db.String(10))
    accounts_account_category = db.Column(db.String(27))
    returns_next_due_date = db.Column(db.String(10))
    returns_last_made_up_date = db.Column(db.String(10))
    ...
    previous_name_1_condate = db.Column(db.String(10))
    previous_name_1_company_name = db.Column(db.String(160))
    previous_name_2_condate = db.Column(db.String(10))
    previous_name_2_company_name = db.Column(db.String(160))
    previous_name_3_condate = db.Column(db.String(10))
    previous_name_3_company_name = db.Column(db.String(102))
    previous_name_4_condate = db.Column(db.String(10))
    previous_name_4_company_name = db.Column(db.String(116))
    previous_name_5_condate = db.Column(db.String(10))
    previous_name_5_company_name = db.Column(db.String(107))
    previous_name_6_condate = db.Column(db.String(10))
    previous_name_6_company_name = db.Column(db.String(64))
    previous_name_7_condate = db.Column(db.String(10))
    previous_name_7_company_name = db.Column(db.String(64))
    previous_name_8_condate = db.Column(db.String(10))
    previous_name_8_company_name = db.Column(db.String(52))
    previous_name_9_condate = db.Column(db.String(10))
    previous_name_9_company_name = db.Column(db.String(52))
    previous_name_10_condate = db.Column(db.String(10))
    previous_name_10_company_name = db.Column(db.String(40))
    conf_stmt_next_due_date = db.Column(db.String(10))
    conf_stmt_last_made_up_date = db.Column(db.String(10))
